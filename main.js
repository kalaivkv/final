        ...
        function displayPost() {
            ...
            paginatedPost.map(post => {
                ...
                postDiv.innerHTML =
                    ...
                    (post.enabled ? '<i class=\"bi bi-toggle2-on\" style=\"color: green; font-size: 1.5rem;\"></i>' : '<i class=\"bi bi-toggle2-off\" style=\"font-size: 1.5rem;color : black;\"></i>') +
                    "</span>" +
                    "</div>" +
                    "<div>" +
                    "<button class='edit' onclick='editPost(\"" + post.id + "\")' style='background-color: blue; color: white; border : none;'><i class='bi bi-pencil-square'></i></button>" +
                    "<button class='delete' onclick='confirmDelete(\"" + post.id + "\")' style='background-color: red; color: white; border : none;'><i class='bi bi-trash'></i></button>" +
                    "</div>";
